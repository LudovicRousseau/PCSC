...
/* This structure allows you to customize your MuscleCard.
   It is used in MSCWriteFramework to specify attributes
   you may want to set in this 'personalization' routine
   and will be getting new values in future revisions of 
   the API                                                 */

#define MSC_INIT_DEFAULT_KEY     0x00 /* Use card's default transport key */
...
#define MSC_TAG_CAPABLE_OBJ_AUTH      303 /* return AUT needed for create */
...
#define MSC_TAG_CAPABLE_PIN_CHARSET   405 /* char set supported (bitmask) */
#define MSC_TAG_CAPABLE_PIN_POLICY    406 /* returns pin policy (bitmask) */
#define MSC_TAG_CAPABLE_PIN_AUTH      407 /* return AUT needed for create */
...
#define MSC_CAPABLE_PIN_NONALPHA  0x00000020 /* Supports all other chars */
...
#define MSC_CAPABLE_PIN_NONALPHA  0x00000020 /* Requires non-alphanumeric */
#define MSC_CAPABLE_PIN_HISTORY   0x00001000 /* Checks pin history        */

    /* Bitmask for TAG MSC_TAG_CAPABLE_ID_STATE   */
#define MSC_CAPABLE_ID_STATE      0x00000001 /* maintains logged id state */
...
#define MSC_CAPABLE_KEYPOLICY_PKCS1_PAD 0x00020000 /* PKCS padding   */
    ...
    /* Structure used in MSCGetStatus to return status and
       capability information about the inserted token      */
...
MSC_RV MSCCancelEventWait( 
  void                                     /* No parameters          */
);

    /* Registers a callback function for event change */
MSC_RV MSCCallbackForTokenEvent(
  MSCLPTokenInfo        tokenArray,        /* Array of token structs */
  MSCULong32            arraySize,         /* Size of the array      */
...
MSC_RV MSCBeginTransaction(
  MSCLPTokenConnection  pConnection       /* Connection handle          */
);			       

    /* Releases a locked transaction to the token */
MSC_RV MSCEndTransaction(
  MSCLPTokenConnection  pConnection,      /* Connection handle          */
...
MSC_RV MSCDeleteCertificate(
  MSCLPTokenConnection  pConnection,
  MSCULong32            certNumber
);
 
MSC_RV MSCListCertificates(
 MSCLPTokenConnection  pConnection,
 MSCUChar8             seqOption,
...
MSC_RV MSCDeleteObject(
  MSCLPTokenConnection	pConnection,
  MSCString  		objectID,
  MSCUChar8		zeroFlag
);

MSC_RV MSCWriteObject(
  MSCLPTokenConnection	pConnection,
  MSCString 		objectID,
  MSCULong32		offset,
  MSCPUChar8	        pInputData,
...
MSC_RV MSCGetKeyAttributes( 
  MSCLPTokenConnection  pConnection, 
  MSCUChar8             keyNumber,
  MSCLPKeyInfo          pKeyInfo 
);

MSC_RV MSCGetObjectAttributes( 
  MSCLPTokenConnection  pConnection, 
  MSCString             objectID,
  MSCLPObjectInfo       pObjectInfo 
);

MSC_RV MSCWriteLargeObject( 
  MSCLPTokenConnection  pConnection, 
  MSCString             objectID,
  MSCPUChar8            pInputData, 
  MSCULong32            dataSize 
...
MSC_RV MSCReadAllocateObjectCB( 
  MSCLPTokenConnection  pConnection, 
  MSCString             objectID,
  MSCPUChar8*           pOutputData, 
  MSCPULong32           dataSize,
...
MSC_RV MSCWriteLargeObjectOffCB( 
  MSCLPTokenConnection  pConnection, 
  MSCString             objectID, 
  MSCULong32            offSet, 
  MSCPUChar8            pInputData, 
...
MSC_RV MSCReadLargeObjectOffCB( 
  MSCLPTokenConnection  pConnection, 
  MSCString             objectID, 
  MSCULong32            offSet, 
  MSCPUChar8            pOutputData, 
