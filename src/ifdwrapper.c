...
LONG IFDSetPTS( PREADER_CONTEXT rContext, DWORD dwProtocol, UCHAR ucFlags, 
  ...
  if ( rContext->dwVersion & IFD_HVERSION_1_0 ) {
    ...
    IFDH_set_protocol_parameters = (RESPONSECODE (*)(DWORD, DWORD,UCHAR, UCHAR,
						     UCHAR, UCHAR)) vFunction;
  }
#endif
...
LONG IFDSetCapabilities( PREADER_CONTEXT rContext, DWORD dwTag, 
  ...
  /* Let the calling function lock this 
...
/* Function: IFDGetCapabilites
   Purpose : This function get's capabilities in the reader.
             Other functions int this file will call the driver
...
LONG IFDPowerICC(  PREADER_CONTEXT rContext, DWORD dwAction, 
  ...
  /* Zero out everything */
  rv=0; vFunction=0; dwStatus=0; dwProtocol=0; ucValue[0]=0;
  ...
  if ( rContext->dwVersion & IFD_HVERSION_1_0 ) {
    ...
    rv = IFDHPowerICC(rContext->dwSlot, dwAction, 
		      pucAtr, dwAtrLen);
  }
#endif
  SYS_MutexUnLock( rContext->mMutex );
...
LONG IFDStatusICC( PREADER_CONTEXT rContext, PDWORD pdwStatus,
  ...
  /* Zero out everything */
  rv=0; rv1=0; vFunctionA=0; vFunctionB=0; 
  dwTag=0; dwCardStatus=0; ucValue[0]=0; 
  ...
  /* Now lets get the ATR and process it if IFD Handler version 1.0
     2.0 does this immediately after reset/power up to conserve resources
  */
...
/* Function: IFDControl
   ...
   a specific action on the reader such as swallow, eject, biometric.
*/
...
LONG IFDTransmit(  PREADER_CONTEXT rContext, SCARD_IO_HEADER pioTxPci,
  ...
  RESPONSECODE (*IFDH_transmit_to_icc)( DWORD, SCARD_IO_HEADER, PUCHAR, DWORD,
  ...
  if ( rContext->dwVersion & IFD_HVERSION_1_0 ) {
    ...
    IFDH_transmit_to_icc  = (RESPONSECODE (*)(DWORD, SCARD_IO_HEADER, PUCHAR, 
					      DWORD, PUCHAR, DWORD*, 
					      PSCARD_IO_HEADER)) vFunction;
  }
#endif  
